      ...
      <div className="relative z-10 flex items-center justify-center h-full mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <animated.div style={buttonSpring}>
            <div className="hidden mb-4 md:mb-8 sm:flex sm:justify-center font-light tracking-wider">
              <div className="relative rounded-full px-3 py-1 text-[12px] md:text-sm text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
          ...
          <animated.div style={logoSpring}>
            <div className="mt-6  flex justify-center">
              <div className="text-center">
                ...
                <p className="mt-4 md:mt-8 text-md md:text-xl text-gray-400 font-normal">
                  Якісне спортивне харчування, персоналізовані набори та
                  аксесуари для ваших тренувань. Все, що потрібно для досягнення
                  ваших цілей, — в одному місці.
                </p>
                <div className="mt-10 flex flex-col md:flex-row justify-center items-center gap-y-6 md:gap-y-0 md:gap-x-6">
                  <Link
                    to="/subscriptions-page"
                    className="rounded-md bg-green-600 px-3 py-2 md:px-6 md:py-3 text-[12px] md:text-sm font-semibold text-white/90 shadow-md hover:bg-green-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 w-[250px] md:w-auto"
                  >
