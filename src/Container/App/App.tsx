  ...
  return (
    <>
      ...
      >
        ...
        <Suspense fallback={<div className="flex justify-center items-center h-screen text-sm md:text-sm lg:text-md xl:text-xl  font-normal text-white/90 my-4 xl:my-6 text-balance break-words ">Заватаження</div>}>
          <Routes>
